  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">승인 완료</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/user/userList">유저 리스트</a></li>
              <li class="breadcrumb-item active">활성화된 유저</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
		...
		<table class="table table-hover text-nowrap">
			...
			<c:forEach var="list" items="${list}">
				<tr>
					...
					<td>
					<form action="${pageContext.request.contextPath}/user/yesUser" method="post">
              ...
              <c:if test="${currentPage > 1}">
                    <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/user/yesUser?currentPage=${currentPage-1}">이전</a></li>
             </c:if>
			 <c:if test="${currentPage < lastPage}">
			    	<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/user/yesUser?currentPage=${currentPage+1}">다음</a></li>
			</c:if>
			</ul>	
      </div><!-- /.container-fluid -->
    </div>
