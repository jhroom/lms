  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">강의 수정</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="javascript:window.history.back();">Lecture One</a></li>
	...
	<div>
		<form action="${pageContext.request.contextPath}/lmsLecture/updateLecture" method="post">
			...
			<button type="button" onclick="history.back()" class="btn btn-success">수정쉬초</button>
